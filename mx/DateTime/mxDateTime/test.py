...
# Range errors
try:
    DateTimeDelta(2**53 + 1.0)
except RangeError:
    pass
else:
    raise AssertionError('DateTimeDelta(2**53 + 1.0) should raise a RangeError')
try:
    MaxDateTimeDelta + 10
except RangeError:
    pass
else:
    raise AssertionError('MaxDateTimeDelta + 10 should raise a RangeError')
try:
    MinDateTimeDelta - 10
except RangeError:
    pass
else:
    raise AssertionError('MinDateTimeDelta - 10 should raise a RangeError')
...
try:
    ...
    # On Windows, a ValueError is raised
    print "Note: dtd.strftime('%f') raises a ValueError on Windows"
...
try:
    ...
    # On Windows, a ValueError is raised
    print "Note: dtd.strftime('%') raises a ValueError on Windows"
