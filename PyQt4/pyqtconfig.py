...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --verbose -q /usr/bin/qmake-qt4 -c -j 10 RPATH= LFLAGS_RPATH= STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= CFLAGS= -g -O2 -fdebug-prefix-map=/build/python-qt4-BjKuiw/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS= -g -O2 -fdebug-prefix-map=/build/python-qt4-BjKuiw/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2 LFLAGS= -Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-O1 -m /usr/lib/python2.7/config-x86_64-linux-gnu -d /usr/lib/python2.7/dist-packages --dbus /usr/include/dbus-1.0',
    'pyqt_mod_dir':      '/usr/lib/python2.7/dist-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtNetwork QtDBus QtDeclarative QtScript QtScriptTools QtOpenGL QtSql QtSvg QtTest QtXml QtXmlPatterns phonon QtAssistant QtDesigner',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   ' -g -O2 -fdebug-prefix-map=/build/python-qt4-BjKuiw/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 ' -g -O2 -fdebug-prefix-map=/build/python-qt4-BjKuiw/python-qt4-4.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security  -Wdate-time -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
